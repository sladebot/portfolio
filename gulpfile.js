...
gulp.task('moveCss', ['clean', 'compileCss']);
...
gulp.task('clean', function(cb) {
    $.cache.clearAll();
    cb(del.sync(['dist/styles', 'dist/scripts', 'dist/images', 'dist/']));
});
...
gulp.task('buildBundle', ['styles', 'cname', 'buildScripts', 'moveLibraries', 'bower'], function() {
    return gulp.src('./app/*.html')
        .pipe($.useref.assets())
        .pipe($.useref.restore())
        .pipe($.useref())
...
gulp.task('watch', ['html', 'fonts', 'bundle'], function() {
    ...
    gulp.watch('app/styles/**/*.scss', ['compileCss']);
